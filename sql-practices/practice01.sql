...
select first_name '이름', gender '성별', hire_date '입사일' from employees order by hire_date asc;
...
select emp_no, title, from_date, to_date from titles where emp_no = 13250 order by from_date asc;